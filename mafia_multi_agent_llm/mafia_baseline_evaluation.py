...
class Game:
    ...
    def __init__(self, openai_api_key, max_tokens, player_count, discussion_depth, use_gpt4, render_markdown, num_mafia=2, num_citizen=3, doctor=True, police=True):
    ...
    def play(self):
        ...
        #save self.accuracy to numpy file in the accuracy folder
        np.save(f'accuracy/accuracy_{time.strftime("%Y%m%d_%H%M%S")}.npy', self.accuracy) ### 11/30 민경현 
        ...
        file_name = f"list_{timestamp}.json"
